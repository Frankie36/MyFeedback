...
class ResponsesTableViewController: UITableViewController, ReachabilityObserverDelegate {
     ...
     */
     ...
     // Pass the selected object to the new view controller.
        ...
        if segue.identifier == "editResponseSegue" {
            let nextScene =  segue.destination as! EditResponseViewController
            // Pass the selected object to the new view controller.
            if let indexPath = self.tableView.indexPathForSelectedRow {
                let selectedResponse = responses[indexPath.row]
                nextScene.response = selectedResponse
            }
        }
     }
